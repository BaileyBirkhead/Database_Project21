...
CREATE TABLE `driver_rating` (
  ...
  CONSTRAINT `rating_supertype` FOREIGN KEY (`rating_id`) REFERENCES `rating` (`rating_id`)
...
INSERT INTO `driver_rating` VALUES (5,5,4),(7,4,4),(10,3,3),(15,4,5),(16,5,3),(17,4,3),(20,3,4),(23,4,2),(24,5,5),(28,3,4),(29,3,2);
...
CREATE TABLE `rating` (
  ...
  CONSTRAINT `rating_to_order` FOREIGN KEY (`order_id`) REFERENCES `orders` (`order_id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `rating` VALUES (1,1,'5'),(2,2,'3'),(3,3,'4'),(4,4,'2'),(5,5,'4'),(6,6,'5'),(7,7,'4'),(8,8,'3'),(9,9,'5'),(10,10,'1'),(11,11,'1'),(12,12,'2'),(13,13,'4'),(14,14,'3'),(15,15,'4'),(16,16,'4'),(17,17,'4'),(18,18,'2'),(19,19,'3'),(20,20,'4'),(21,21,'5'),(22,22,'2'),(23,23,'3'),(24,24,'4'),(25,25,'3'),(26,26,'2'),(27,27,'4'),(28,28,'4'),(29,29,'5'),(30,30,'3');
...
CREATE TABLE `restaurant_rating` (
  ...
  `price` int NOT NULL,
  PRIMARY KEY (`rating_id`),
  CONSTRAINT `rating_super` FOREIGN KEY (`rating_id`) REFERENCES `rating` (`rating_id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `restaurant_rating` VALUES (5,4,5),(7,3,2),(10,4,5),(15,2,4),(16,4,4),(17,3,2),(20,4,5),(23,2,2),(24,3,2),(28,4,4);
...
--
/*!50003 DROP PROCEDURE IF EXISTS `customerOrderWeek` */;
...
DELIMITER ;;
CREATE DEFINER=`root`@`localhost` PROCEDURE `customerOrderWeek`(
IN customerID INT,
...
/*!50003 DROP PROCEDURE IF EXISTS `driverDeliveryWeek` */;
/*!50003 SET @saved_cs_client      = @@character_set_client */ ;
/*!50003 SET @saved_cs_results     = @@character_set_results */ ;
/*!50003 SET @saved_col_connection = @@collation_connection */ ;
/*!50003 SET character_set_client  = utf8mb4 */ ;
...
/*!50003 SET sql_mode              = 'STRICT_TRANS_TABLES,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
CREATE DEFINER=`root`@`localhost` PROCEDURE `driverDeliveryWeek`(
IN driverID INT,
IN weekStart DATETIME,
IN weekEnd DATETIME
)
...
/*!50003 SET character_set_results = @saved_cs_results */ ;
/*!50003 SET collation_connection  = @saved_col_connection */ ;
/*!50003 DROP PROCEDURE IF EXISTS `driverRating` */;
/*!50003 SET @saved_cs_client      = @@character_set_client */ ;
/*!50003 SET @saved_cs_results     = @@character_set_results */ ;
/*!50003 SET @saved_col_connection = @@collation_connection */ ;
/*!50003 SET character_set_client  = utf8mb4 */ ;
...
/*!50003 SET sql_mode              = 'STRICT_TRANS_TABLES,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
CREATE DEFINER=`root`@`localhost` PROCEDURE `driverRating`(
IN driverID INT)
BEGIN
...
/*!50003 SET character_set_results = @saved_cs_results */ ;
/*!50003 SET collation_connection  = @saved_col_connection */ ;
/*!50003 DROP PROCEDURE IF EXISTS `restRating` */;
/*!50003 SET @saved_cs_client      = @@character_set_client */ ;
/*!50003 SET @saved_cs_results     = @@character_set_results */ ;
/*!50003 SET @saved_col_connection = @@collation_connection */ ;
/*!50003 SET character_set_client  = utf8mb4 */ ;
...
/*!50003 SET sql_mode              = 'STRICT_TRANS_TABLES,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
CREATE DEFINER=`root`@`localhost` PROCEDURE `restRating`(
IN restID INT)
BEGIN
select max(overall_rating) AS max_rating, min(overall_rating) AS min_rating, avg(overall_rating) AS avg_rating
from rating
...
/*!50001 VIEW `overview` AS select `orders`.`order_id` AS `order_id`,`orders`.`person_id` AS `person_id`,`orders`.`delivery_id` AS `delivery_id`,`orders`.`location_id` AS `location_id`,`orders`.`driver_id` AS `driver_id`,`orders`.`restaurant_id` AS `restaurant_id`,`orders`.`total_price` AS `total_price`,`orders`.`delivery_charge` AS `delivery_charge` from `orders` */;
...
-- Dump completed on 2021-11-29 12:27:11
